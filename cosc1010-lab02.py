...
# I had an unexpected indent on first_name because it defaults to straight under the comment
# 
# 
...
my_variable = "cowboy joe"
print(my_variable.title())
...
university_name = "The University of Wyoming"
university_year = 1886
print(f"The {university_name} was founded in {university_year}")
